...
Request(c,S) ≜
  ...
  ∧ network' = network ∪ {[type ↦ "request", clt ↦ c, rsrc ↦ S]}
...
Liveness ≜
  ∧ ∀ c ∈ Clients : WF_vars(requests[c]={} ∧ Return(c,holding[c]))
...
ResourceMutex ≜
  ∀ c1,c2 ∈ Clients : holding[c1] ∩ holding[c2] ≠ {} ⇒ c1 = c2

ClientsWillReturn ≜
  ∀ c ∈ Clients: (requests[c]={} ↝ holding[c]={})

ClientsWillObtain ≜
  ∀ c ∈ Clients, r ∈ Resources : r ∈ requests[c] ↝ r ∈ holding[c]

InfOftenSatisfied ≜ 
  ∀ c ∈ Clients : □◇(requests[c] = {})
