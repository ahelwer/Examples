...
ASSUME MAssumption ≜ M ∈ ℕ \ {0} \* Value domain of c 
...
---------------------------------------------------------------------------------------
UniqueToken ≜
    ∃ i ∈ 0 ‥ N :                           \* unique token at i (or i=N => token is at 0)
       ∧ ∀ j ∈ 0‥i-1: c[j]= c[0]           \* before i all c equals c[0] 
       ∧ ∀ j ∈ i‥N-1: c[j]= (c[0]-1) % M   \* after i all c following c[0]
