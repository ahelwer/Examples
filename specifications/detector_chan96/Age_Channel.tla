...
Pickup(msgs) ≜ 
  ∧ inTransit' = inTransit ∪ Pack_WaitingTime(msgs)
  ∧ inDelivery' = {}  
...
Deliver(rcver) ≜
  ∃ boxes ∈ SUBSET inTransit :
      ∧ ∀ box ∈ boxes : box.content.to = rcver
