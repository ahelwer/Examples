...
VTPTypeOK ≜
  ...
  (*************************************************************************)
  ∧ vState ∈ [V → {"phantom", "valid"}]
  ∧ vlcState ∈ [V → {"init", "working"}]
  ∧ hState ∈ [H → {"waiting", "prepared", "holding", "aborted"}]
  ∧ iState ∈ [I → {"waiting", "prepared", "issued", "aborted"}]
  ∧ vtpState ∈ {"init", "done"}
  ∧ vtpIPrepared ⊆ (H ∪ I)
  ∧ msgs ⊆ Messages
