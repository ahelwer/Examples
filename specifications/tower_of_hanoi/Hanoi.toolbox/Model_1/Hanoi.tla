...
(* DOMAIN f.                                                               *)
(***************************************************************************)
Sum(f) ≜ LET DSum[S ∈ SUBSET DOMAIN f] ≜
               LET elt ≜ CHOOSE e ∈ S : TRUE
               IN  IF S = {} THEN 0
...
TypeOK ≜ ∧ ∀ i ∈ DOMAIN towers : ∧ towers[i] ∈ ℕ \* Towers are represented by natural numbers
                                 ∧ towers[i] < 2^D
...
(***************************************************************************)
Init ≜ ∧ towers = [i ∈ 1‥N ↦ IF i = 1 THEN 2^D - 1 ELSE 0] \* all towers are empty except all disks are on the first Tower
...
(***************************************************************************)
Next ≜ ∃ d ∈ SetOfPowerOfTwo(D): ∃ idx1, idx2 ∈ DOMAIN towers: 
